...
\begin{figure}[ht!]
	\centering{
		\includegraphics[width=0.5\textwidth]{assets/images/sha256.jpg}
		\caption{Результат работы с хешированием}
		\label{TODO:risnok:1}}
\end{figure}

На рисунке \ref{TODO:risnok:2} представлен результат работы без шифрования и время выполнения (329342 мкс.).
